...
public static class ENetPeers
{
    ...
    public static ENetIncomingCommand enet_peer_queue_incoming_command(ENetPeer peer, ref ENetProtocol command, byte[] data, ulong dataLength, ENetPacketFlag flags, uint fragmentCount)
    {
        ENetChannel channel = peer.channels[command.header.channelID];
